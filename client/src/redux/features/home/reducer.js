...
const initState = { loading: false, error: false, clothData: [], shoeData: [], earingData: [] };
...
export const homeReducer = (state = initState, { type, payload }) => {
    switch (type) {
        ...
        case GET_DATA_SUCCESS_EARING:
            return { ...state, loading: false, earingData: payload, error: false };
